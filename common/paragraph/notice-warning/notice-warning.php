<?php
/**
 * Display as a "warning" notice with a exclamation mark dashicon (svg).
 *
 * How to use:
...
function slug_editor_assets() {
	wp_enqueue_script( 'slug-block-styles-script', get_theme_file_uri( 'notice-warning-block-styles.js' ), array( 'wp-blocks', 'wp-i18n' ) );
...
function slug_block_styles() {
	wp_enqueue_style( 'slug-block-styles', get_theme_file_uri( 'notice-warning-block-styles.css' ), false );
}
